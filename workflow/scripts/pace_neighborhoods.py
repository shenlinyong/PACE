...
def main():
    ...
    parser.add_argument('--H3K27me3_weight', type=float, default=0.5,
                       help='Weight for H3K27me3 (inhibitory)')
    parser.add_argument('--H3K9me3_weight', type=float, default=0.5,
    ...
    # Collect inhibitory (repressive) histone marks. These were previously
    # accepted on the command line but never used; they are now integrated as
    # inhibitory signals that down-weight enhancer activity.
    inhibitory_histone_files = {}
    inhibitory_weights = {}

    if args.H3K27me3 and os.path.exists(args.H3K27me3):
        inhibitory_histone_files['H3K27me3'] = args.H3K27me3
        inhibitory_weights['H3K27me3_signal'] = args.H3K27me3_weight

    if args.H3K9me3 and os.path.exists(args.H3K9me3):
        inhibitory_histone_files['H3K9me3'] = args.H3K9me3
        inhibitory_weights['H3K9me3_signal'] = args.H3K9me3_weight

    if args.methylation and os.path.exists(args.methylation):
        inhibitory_weights['methylation_signal'] = args.methylation_weight
    ...
    enhancer_file, gene_file = run_neighborhoods(
        ...
        inhibitory_histone_files=inhibitory_histone_files or None,
        inhibitory_weights=inhibitory_weights or None,
