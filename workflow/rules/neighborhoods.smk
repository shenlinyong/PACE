...
rule create_neighborhoods:
    ...
    params:
        ...
        H3K36me3 = lambda wildcards: BIOSAMPLES_CONFIG.loc[wildcards.biosample, "H3K36me3"] if "H3K36me3" in BIOSAMPLES_CONFIG.columns and pd.notna(BIOSAMPLES_CONFIG.loc[wildcards.biosample, "H3K36me3"]) else '',
        H3K9ac = lambda wildcards: BIOSAMPLES_CONFIG.loc[wildcards.biosample, "H3K9ac"] if "H3K9ac" in BIOSAMPLES_CONFIG.columns and pd.notna(BIOSAMPLES_CONFIG.loc[wildcards.biosample, "H3K9ac"]) else '',
        H3K27me3 = lambda wildcards: BIOSAMPLES_CONFIG.loc[wildcards.biosample, "H3K27me3"] if "H3K27me3" in BIOSAMPLES_CONFIG.columns and pd.notna(BIOSAMPLES_CONFIG.loc[wildcards.biosample, "H3K27me3"]) else '',
        H3K9me3 = lambda wildcards: BIOSAMPLES_CONFIG.loc[wildcards.biosample, "H3K9me3"] if "H3K9me3" in BIOSAMPLES_CONFIG.columns and pd.notna(BIOSAMPLES_CONFIG.loc[wildcards.biosample, "H3K9me3"]) else '',
