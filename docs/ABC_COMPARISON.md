...
For the same activity, contact and complete planned candidates, setting eta to zero gives
...
explicit `ABC_style_single_TSS` control and `contact_power_2` (A×Cbar²). That control selects the physical TSS with
